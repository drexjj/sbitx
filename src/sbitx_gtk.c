...
double apf_center_frequency = 700.0; // APF CW tone in Hz
double apf_bandwidth = 100.0; // Bandwidth of the APF in Hz
...
/* end of common controls */
  ...
  //Audio Peak Filter Controls
  { "#apf_plugin", NULL, 1000, -1000, 40, 40, "APF", 40, "OFF", FIELD_TOGGLE, FONT_FIELD_VALUE,
		"ON/OFF",0,0,0,0},
  { "#apf_tonefreq", do_apf_edit, 1000, -1000, 40, 40, "TONE", 80, "700", FIELD_NUMBER, FONT_FIELD_VALUE, 
		"",100, 1000, 10,0}, 
  { "#apf_bandwidth", do_apf_edit, 1000, -1000, 40, 40, "BNDWTH", 80, "100", FIELD_NUMBER, FONT_FIELD_VALUE, 
		"",50, 800, 10,0},
...
void menu_display(int show) {
    ...
    if (show) {
        ...
        //field_move("TONE", 610, screen_height - 145, 45, 45); 
        //field_move("BNDWTH", 610, screen_height - 95, 45, 45);
        //field_move("APF", 555, screen_height - 120, 45, 45); //not working 100%
        ...
        //field_move("TONE", -1000, screen_height - 145, 45, 45);
        //field_move("BNDWTH", -1000, screen_height - 95, 45, 45);
        //field_move("APF", -1000, screen_height - 120, 45, 45);
...
int do_apf_edit(struct field *f, cairo_t *gfx, int event, int a, int b, int c) {
    if (!strcmp(get_field("#apf_plugin")->value, "ON")) {
        struct field *get_apf_centerfreq = get_field("#apf_tonefreq");
        int apf_center_frequency_value = atoi(get_apf_centerfreq->value);
        apf_center_frequency = apf_center_frequency_value;  
        struct field *get_apf_bandwidth = get_field("#apf_bandwidth");
        int apf_bandwidth_value = atoi(get_apf_bandwidth->value);
        apf_bandwidth=apf_bandwidth_value;
    }
...
//gboolean check_controls(gpointer data) { // Function to call both check_eq_control and check_dsp_control
//    check_eq_control(NULL);
//    check_dsp_control(NULL);
//    check_apf_control(NULL);
//    check_anr_control(NULL);
